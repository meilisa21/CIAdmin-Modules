...
<div class="login-box">
  ...
  <div class="card">
    <div class="card-body login-card-body">
      ...
      <p class="mb-1">
        <a href="<?php echo base_url('login/forget-password'); ?>">I forgot my password</a>
      </p>
      <p class="mb-0">
        <a href="<?php echo base_url('register/register'); ?>" class="text-center">Register a new membership</a>
      </p>
    </div>
    <!-- /.login-card-body -->
  </div>
